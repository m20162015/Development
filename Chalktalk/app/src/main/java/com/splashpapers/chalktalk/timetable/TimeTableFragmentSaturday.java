 ...
 */
public class TimeTableFragmentSaturday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mItems = TimeTableModel.getInstance().getTimeTableList("SAT");
    ...
    private void callRequest()
    {
        ...
        timeTableRequest.setFragmentSaturday(this);
        timeTableRequest.setKey("SAT");
        timeTableRequest.callRequest("SAT",TimeTableConstants.TIMETABLE_FUNCTION_NAME,getParameters());
    }
...
//            classId = "1";
        ...
        parameters.put(TimeTableConstants.DAY, "Saturday");
    ...
    public void onResume() {
        ...
        setVisibilityEmptyList(mEmptyList, TimeTableModel.getInstance().getTimeTableList("SAT").size());
        Log.d("Call resume","Resume called Sat");
    }
}
