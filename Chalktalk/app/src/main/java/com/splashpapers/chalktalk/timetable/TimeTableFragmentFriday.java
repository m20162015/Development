 ...
 */
public class TimeTableFragmentFriday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mItems = TimeTableModel.getInstance().getTimeTableList("FRI");
    ...
    private void callRequest()
    {
        ...
        timeTableRequest.setFragmentFriday(this);
        timeTableRequest.setKey("FRI");
        timeTableRequest.callRequest("FRI",TimeTableConstants.TIMETABLE_FUNCTION_NAME,getParameters());
    }
...
//            classId = "1";
        ...
        parameters.put(TimeTableConstants.DAY, "Friday");
    ...
    public void onResume() {
        ...
        setVisibilityEmptyList(mEmptyList, TimeTableModel.getInstance().getTimeTableList("FRI").size());
        Log.d("Call resume","Resume called fri");
    }
}
