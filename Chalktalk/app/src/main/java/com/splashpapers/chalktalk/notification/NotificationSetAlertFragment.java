...
public class NotificationSetAlertFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mItems = NotificationModel.getInstance().getNotificationList("ALERT");
    ...
    private void callRequest()
    {
        ...
        notificationRequest.setNotificationSetAlertFragment(this);
        notificationRequest.setKey("ALERT");
        notificationRequest.callRequest("ALERT",NotificationConstants.NOTIFICATION_FUNCTION_NAME,getParameters());
    }
...
//            classId = "1";
    ...
    public void onResume() {
        ...
        setVisibilityEmptyList(mEmptyList, NotificationModel.getInstance().getNotificationList("ALERT").size());
    }
}
