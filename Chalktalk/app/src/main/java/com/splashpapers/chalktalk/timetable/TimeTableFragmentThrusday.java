 ...
 */
public class TimeTableFragmentThrusday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mItems = TimeTableModel.getInstance().getTimeTableList("THU");
    ...
    private void callRequest()
    {
        ...
        timeTableRequest.setFragmentThrusday(this);
        timeTableRequest.setKey("THU");
        timeTableRequest.callRequest("THU",TimeTableConstants.TIMETABLE_FUNCTION_NAME,getParameters());
    }
    ...
    private HashMap<String, String> getParameters() {
        ...
        parameters.put(TimeTableConstants.DAY, "Thursday");
    ...
    public void onResume() {
        ...
        setVisibilityEmptyList(mEmptyList, TimeTableModel.getInstance().getTimeTableList("THU").size());
        Log.d("Call resume","Resume called thu");
    }
}
