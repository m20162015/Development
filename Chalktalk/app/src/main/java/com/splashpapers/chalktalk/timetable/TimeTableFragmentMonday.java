 ...
 */
public class TimeTableFragmentMonday extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            mItems = TimeTableModel.getInstance().getTimeTableList("MON");
    ...
    private void callRequest()
    {
        ...
        timeTableRequest.setFragment(this);
        timeTableRequest.setKey("MON");
        timeTableRequest.callRequest("MON",TimeTableConstants.TIMETABLE_FUNCTION_NAME,getParameters());
    }
    ...
    private HashMap<String, String> getParameters() {
        ...
        parameters.put(TimeTableConstants.DAY, "Monday");
    ...
    public void onResume() {
        ...
        setVisibilityEmptyList(mEmptyList, TimeTableModel.getInstance().getTimeTableList("MON").size());
        Log.d("Call resume","Resume called Monday");
    }
}
