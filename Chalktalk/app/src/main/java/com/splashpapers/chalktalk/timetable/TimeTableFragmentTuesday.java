 ...
 */
public class TimeTableFragmentTuesday extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mItems = TimeTableModel.getInstance().getTimeTableList("TUE");
    ...
    private void callRequest()
    {
        ...
        timeTableRequest.setFragmentTuesday(this);
        timeTableRequest.setKey("TUE");
        timeTableRequest.callRequest("TUE", TimeTableConstants.TIMETABLE_FUNCTION_NAME,getParameters());
    }
    ...
    private HashMap<String, String> getParameters() {
        ...
        parameters.put(TimeTableConstants.DAY, "Tuesday");
    ...
    public void onResume() {
        ...
        setVisibilityEmptyList(mEmptyList, TimeTableModel.getInstance().getTimeTableList("TUE").size());
        Log.d("Call resume","Resume called Tue");
    }
}
